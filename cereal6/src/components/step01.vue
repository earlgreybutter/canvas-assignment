...
// CustomUserObject
window.CustomUserObject = function(name, type, showNhide) {
  this.name = name || "New Name";
  this.type = type || "New Type";
  this.showNhide = showNhide || true;
  this.clone = function() {
    ...
    createGraph() {
      ...
      if (!mxClient.isBrowserSupported()) {
        ...
        mxConnectionHandler.prototype.connectImage = new mxImage(
          require("../assets/images/handle-connect.png"),
          16,
          16
        );
        ...
        editor.graph.isCellVisible = function(cell) {
          var result = mxGraph.prototype.isCellVisible.apply(this, arguments);
					
					if (result && cell.value.showNhide == false)
					{
						result = false
					}
